...
[FIGURE 1 — REQUIRED. *Context diagram of the Day 6 work package:* inputs (Day 1 requirements, Day 2 Δv budgets, Day 3 engine data, Day 4 architecture/mass) → recovery-concept definition (this report) → outputs (Day 7 verification cases; Day 8 cost/risk inputs). Single-column block diagram.]
...
[FIGURE 2 — REQUIRED. *Bar chart, log scale:* per-flight cost components for (a) expendable baseline, (b) reusable at 15 flights/booster, (c) reusable at 25 flights/booster — building hardware amortization vs refurbishment vs operations; data from Table §2.1–2.2.]
...
At fixed GLOM, the selection frees 2,500 kg of flying hardware mass and 6,000 kg of reserve propellant relative to the legged fallback — reinvested in Day 4 into +5,000 kg ascent propellant and +4,500 kg growth margin. The selection is externally event-anchored: the Long March 10B flight of 10 July 2026 demonstrated the exact terminal function (hooks onto tensioned ship cables) six days before this report's issue [13–16].

[FIGURE 3 — REQUIRED. *Trade-study matrix graphic:* six method families (rows) × six criteria (columns), scored ●◐○, with the selected row highlighted; companion to Tables 2–3.]
...
[FIGURE 4 — REQUIRED. *System schematic (vertical stack):* booster with callouts for catch ring, lug/wear-shoe detail (inset), grid fins, crush pads, sensor routing; adjacent vessel frame with tensioned cables and dampers; arrow chain illustrating the §4.3 load path.]
...
[FIGURE 5 — REQUIRED. *Altitude-versus-downrange schematic* of the seven phases (quantitatively indicating the §5.1–5.3 anchors; vessel symbol at 400–650 km; inset: capture-frame engagement geometry).]
[FIGURE 6 — REQUIRED. *Terminal-phase velocity–altitude diagram* showing the hover-slam commitment boundary (burn-start window from Eq. 5.2 logic) and the miss-the-vessel bias corridor.]
...
[FIGURE 7 — REQUIRED. *Waterfall chart* of Table 5: available band (1.03–1.13 km/s) versus the stacked allocations, with the unfunded boostback block hatched.]
