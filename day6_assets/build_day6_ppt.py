...
bullet_block(s, 0.85, 5.08, 11.8, 1.5, [
 ("释放质量：", "回收硬件 −2,500 kg、回收储备 −6,000 kg；"),
...
s.shapes.add_picture("day6_assets/svg_recovery_sequence.png", Inches(1.56), Inches(1.22), width=Inches(10.22))
...
s.shapes.add_picture("day6_assets/svg_hover_slam.png", Inches(6.45), Inches(1.30), width=Inches(6.45))
...
s.shapes.add_picture("day6_assets/svg_catch_loadpath.png", Inches(1.85), Inches(1.22), width=Inches(9.64))
...
s.shapes.add_picture("day6_assets/svg_reserve_closure.png", Inches(0.60), Inches(1.30), width=Inches(7.6))
...
items = [
 ("质量闭合", "相对着陆腿备份：回收硬件 −2.5 t、储备 −6.0 t（固定 600 t GLOM 内再投资于上升推进剂与裕度）"),
...
prs.save("Day6_可重复使用策略_回收概念.pptx")
print("Saved Day6_可重复使用策略_回收概念.pptx, slides:", len(prs.slides._sldIdLst))
